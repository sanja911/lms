			...
			Baru Di Kelas Online ?
			<hr>
				<h3 class="form-signin-heading"><i class="icon-edit"></i> Daftar</h3>
				<button data-placement="top" title="Sebagai Siswa" id="signin_student" onclick="window.location='signup_student.php'" id="btn_student" name="login" class="btn btn-info" type="submit">Saya Adalah Siswa</button>
				<div class="pull-right">
					<button data-placement="top" title="Sebagai Guru" id="signin_teacher" onclick="window.location='signup_teacher.php'" name="login" class="btn btn-info" type="submit">Saya Adalah Guru</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
